...
def main():
    ...
    parser.add_argument("--zircon-userspace-project-prefix",
                        help="string prefixed to zircon userspace project name",
                        dest="zircon_userspace_project_prefix", action="store")
    ...
    if args.zircon_userspace_project_prefix:
        gn_args.append('zircon_userspace_project_prefix="%s"' % args.zircon_userspace_project_prefix)
